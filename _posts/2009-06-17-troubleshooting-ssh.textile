...
h3. TortoisePlink popps up and asks for username ("login as")

When trying to access a github.com repository, a prompt titled "TortoisePlink" may pop up, asking to supply the username to login with. Independant of the typed in text, PuTTY will claim that there are no authentication methods available. To solve this, clear or delete the following registry entry:
<pre>
HKEY_CURRENT_USER > Software > SimonTatham > Putty >
                  > Sessions > Default%20Settings > HostName
</pre>
This solution was taken from a "similar TortoiseSVN complaint":http://old.nabble.com/Bug-with-TortoisePlink-td18812277.html.
